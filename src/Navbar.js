...
function Navbar() {
  ...
  return (
    <nav class="flex md:container py-5 md:mx-auto justify-between items-center bg-black text-white pt-10">
      {/* <!-- Logo & Menu --> */}
      ...
      <div class="md:hidden relative flex-grow h-[25px]">
        ...
        <div class="">
          <div
            ...
            } z-10 absolute flex-col items-center py-8 mt-10 space-y-6 bg-black w-screen self-center drop-shadow-md right-0`}
          >
            <div class="hover:text-red-800 transition duration-300">
              <Link to="/">Home</Link>
            </div>
            <div class="hover:text-red-800 transition duration-300">
              <Link to="/Live">Live</Link>
